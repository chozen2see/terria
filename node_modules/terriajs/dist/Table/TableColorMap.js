...
export default class TableColorMap {
    ...
    get outlierColor() {
        ...
        return this.colorTraits.outlierColor
            ? (_a = Color.fromCssColorString(this.colorTraits.outlierColor)) !== null && _a !== void 0 ? _a : Color.AQUAMARINE : Color.AQUAMARINE;
    }
    get nullColor() {
        var _a;
    ...
    get minimumValue() {
        ...
        if (this.validValues)
            return getMin(this.validValues);
    }
    ...
    get maximumValue() {
        ...
        if (this.validValues)
            return getMax(this.validValues);
    }
