 ...
 *
 */
export default class TerriaReference extends UrlMixin(ReferenceMixin(CreateModel(TerriaReferenceTraits))) {
    constructor() {
        super(...arguments);
        this.forceLoadReference = flow(function* (_previousTarget) {
...
TerriaReference.type = "terria-reference";
/**
