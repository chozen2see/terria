...
export default class MagdaReference extends AccessControlMixin(UrlMixin(ReferenceMixin(CreateModel(MagdaReferenceTraits)))) {
    ...
    async forceLoadReference(previousTarget) {
        ...
        return await runLater(async () => {
            const target = MagdaReference.createMemberFromRecord(this.terria, this, distributionFormats, magdaUri, this.uniqueId, existingRecord, override, previousTarget);
            if (target !== undefined) {
                return target;
            }
            ...
            return MagdaReference.createMemberFromRecord(this.terria, this, distributionFormats, magdaUri, this.uniqueId, record, override, previousTarget);
        });
    }
    static createMemberFromRecord(terria, sourceReference, distributionFormats, magdaUri, id, record, override, previousTarget) {
        if (record === undefined) {
            return undefined;
        }
