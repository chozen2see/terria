...
class WebFeatureServiceCatalogItem extends ExportableMixin(MappableMixin(GetCapabilitiesMixin(UrlMixin(CatalogMemberMixin(CreateModel(WebFeatureServiceCatalogItemTraits)))))) {
    constructor() {
        super(...arguments);
    ...
    async forceLoadMapItems() {
        ...
        runInAction(() => {
            this.geojsonCatalogItem = new GeoJsonCatalogItem(createGuid(), this.terria, this);
            this.geojsonCatalogItem.setTrait(CommonStrata.definition, "geoJsonData", geojsonData);
            if (isDefined(this.style))
                this.geojsonCatalogItem.setTrait(CommonStrata.definition, "style", this.style);
        });
    ...
    get _canExportData() {
        var _a;
        return isDefined((_a = this.geojsonCatalogItem) === null || _a === void 0 ? void 0 : _a.geoJsonData);
    }
    async _exportData() {
        var _a;
        if (isDefined((_a = this.geojsonCatalogItem) === null || _a === void 0 ? void 0 : _a.geoJsonData)) {
            return {
    ...
    get shortReport() {
        ...
        if (isObservableArray((_b = (_a = this.geojsonCatalogItem) === null || _a === void 0 ? void 0 : _a.geoJsonData) === null || _b === void 0 ? void 0 : _b.features) &&
...
__decorate([
    observable
], WebFeatureServiceCatalogItem.prototype, "geojsonCatalogItem", void 0);
__decorate([
    computed
], WebFeatureServiceCatalogItem.prototype, "typeNamesArray", null);
__decorate([
    computed
], WebFeatureServiceCatalogItem.prototype, "_canExportData", null);
__decorate([
    computed
], WebFeatureServiceCatalogItem.prototype, "mapItems", null);
__decorate([
    computed
