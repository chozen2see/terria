...
export const DataCatalogItem = observer(createReactClass({
    ...
    async toggleEnable(event) {
        ...
        if (toAdd) {
            ...
            (await this.props.terria.workbench.add(this.props.item)).raiseError(this.props.terria, undefined, true // We want to force show error to user here - because this function is called when a user clicks the "Add to workbench"  buttons
            );
        }
        else {
