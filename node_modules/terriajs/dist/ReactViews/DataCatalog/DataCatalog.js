...
export const DataCatalog = observer(createReactClass({
    ...
    render() {
        ...
        return (React.createElement("ul", { className: Styles.dataCatalog },
            React.createElement(If, { condition: isSearching && catalogSearchProvider },
                React.createElement("label", { className: Styles.label }, t("search.resultsLabel")),
                React.createElement(SearchHeader, { searchResults: catalogSearchProvider, isWaitingForSearchToStart: searchState.isWaitingToStartCatalogSearch })),
            React.createElement(For, { each: "item", of: items }, item !== this.props.terria.catalog.userAddedDataGroup && (React.createElement(DataCatalogMember, { viewState: this.props.viewState, member: item, 
                ...
                manageIsOpenLocally: isSearching && !catalogSearchProvider.resultsAreReferences, key: item.uniqueId, overrideState: this.props.overrideState, onActionButtonClicked: this.props.onActionButtonClicked, removable: this.props.removable, terria: this.props.terria, isTopLevel: true })))));
    }
}));
