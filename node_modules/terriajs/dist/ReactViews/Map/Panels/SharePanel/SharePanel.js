...
const SharePanel = observer(createReactClass({
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("div", { className: DropdownStyles.section },
                ...
                React.createElement("div", null,
                    React.createElement("button", { className: Styles.printButton, onClick: this.print, disabled: this.state.creatingPrintView }, t("share.printButton")),
                    React.createElement("button", { className: Styles.printButton, onClick: this.showPrintView, disabled: this.state.creatingPrintView }, t("share.printViewButton")),
                    React.createElement("div", { className: Styles.printViewLoader }, this.state.creatingPrintView && (React.createElement(Loader, { message: t("share.creatingPrintView") }))))),
    ...
    renderDownloadFormatButton(format) {
        return (React.createElement("button", { key: format.name, className: Styles.formatButton, onClick: this.download, disabled: this.state.creatingDownload }, format.name));
    },
    openWithUserClick() {
