...
let MappablePreview = class MappablePreview extends React.Component {
    async toggleOnMap(event) {
        ...
        if (toAdd) {
            (await this.props.terria.workbench.add(this.props.previewed)).raiseError(this.props.terria, undefined, true // We want to force show error to user here - because this function is called when a user clicks the "Add to workbench"  buttons
            );
        }
        else {
