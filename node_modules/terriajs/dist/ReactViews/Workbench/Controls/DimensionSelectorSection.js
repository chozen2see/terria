...
import SelectableDimensions, { DEFAULT_PLACEMENT, MAX_SELECTABLE_DIMENSION_OPTIONS } from "../../../Models/SelectableDimensions";
...
let DimensionSelectorSection = class DimensionSelectorSection extends React.Component {
    ...
    render() {
        ...
        const selectableDimensions = (_a = item.selectableDimensions) === null || _a === void 0 ? void 0 : _a.filter(dim => 
        ...
        return (React.createElement(Box, { displayInlineBlock: true, fullWidth: true },
            ...
            selectableDimensions.map((dim, i) => {
                ...
                return (React.createElement(React.Fragment, { key: `${item.uniqueId}-${dim.id}-fragment` },
                    ...
                    React.createElement(Checkbox, { isChecked: dim.selectedId === "true", label: (_c = (_b = (_a = dim.options) === null || _a === void 0 ? void 0 : _a.find(opt => opt.id === dim.selectedId)) === null || _b === void 0 ? void 0 : _b.name) !== null && _c !== void 0 ? _c : (dim.selectedId === "true" ? "Enabled" : "Disabled"), onChange: evt => this.setDimensionValue(dim, evt.target.checked ? "true" : "false") })) : (
