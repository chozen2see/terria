...
const DateTimeSelectorSection = observer(createReactClass({
    ...
    render() {
        ...
        return (React.createElement("div", { className: Styles.datetimeSelector },
            React.createElement("div", { className: Styles.title }, "Time:"),
            React.createElement("div", { className: Styles.datetimeSelectorInner },
                React.createElement("div", { className: Styles.datetimeAndPicker },
                    React.createElement("button", { className: Styles.datetimePrevious, disabled: !item.isPreviousDiscreteTimeAvailable, onClick: this.onPreviousButtonClicked, title: t("dateTime.previous") },
                        React.createElement(Icon, { glyph: Icon.GLYPHS.previous })),
                    React.createElement("button", { className: Styles.currentDate, onClick: this.toggleOpen, title: t("dateTime.selectTime") }, defined(discreteTime)
                        ? discreteTime
                        : t("dateTime.outOfRange")),
                    React.createElement("button", { className: Styles.datetimeNext, disabled: !item.isNextDiscreteTimeAvailable, onClick: this.onNextButtonClicked, title: t("dateTime.next") },
                        React.createElement(Icon, { glyph: Icon.GLYPHS.next }))),
                React.createElement("div", { className: Styles.picker, title: t("dateTime.selectTime") },
                ...
                React.createElement(TimelineButton, { className: classNames(Styles.timelineButton, {
                        [Styles.timelineActive]: attachedToTimeline
                    }), active: attachedToTimeline, type: "button", onClick: this.onTimelineButtonClicked, title: t("dateTime.useTimeline") },
                    React.createElement(Icon, { glyph: Icon.GLYPHS.timeline })),
                React.createElement(TimelineButton, { className: classNames(Styles.timelineButton, {
                        [Styles.timelineActive]: item.showInChartPanel
                    }), active: item.showInChartPanel, type: "button", onClick: this.onShowOnChartButtonClicked, title: t("dateTime.availableTimeChart") },
