...
export default class ArcGisMapServerCatalogItemTraits extends mixTraits(MappableTraits, FeatureInfoTraits, RasterLayerTraits, LayerOrderingTraits, MappableTraits, UrlTraits, CatalogMemberTraits, DiscretelyTimeVaryingTraits, MinMaxLevelTraits) {
    constructor() {
        super(...arguments);
