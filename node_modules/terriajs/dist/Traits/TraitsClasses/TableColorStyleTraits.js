...
__decorate([
    primitiveTrait({
        name: "Outlier Color",
        description: 'The color to use when the value is considered an "outlier" (and therefore not shown on color scale), specified as a CSS color string. This will only apply if `zScoreFilter` is defined',
        type: "string"
    })
