...
export default class TableTraits extends mixTraits(DiscretelyTimeVaryingTraits, ExportableTraits, LayerOrderingTraits, CatalogMemberTraits, MappableTraits, RasterLayerTraits, ChartPointOnMapTraits, CatalogMemberTraits) {
    constructor() {
        super(...arguments);
...
__decorate([
    objectTrait({
        name: "Default Style",
        description: "The default style to apply when visualizing any column in this CSV.",
        type: TableStyleTraits
    })
...
__decorate([
    primitiveArrayTrait({
        name: "Column titles",
        description: "An optional array of column titles that override the individual `TableColumnTraits.title` setting.",
        type: "string"
    })
...
__decorate([
    primitiveArrayTrait({
        name: "Column units",
        description: "An optional array of column units that override the individual `TableColumnTraits.unit` setting.",
        type: "string"
    })
