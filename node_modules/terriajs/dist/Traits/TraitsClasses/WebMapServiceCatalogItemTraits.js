...
let WebMapServiceCatalogItemTraits = class WebMapServiceCatalogItemTraits extends mixTraits(ExportableTraits, DiffableTraits, FeatureInfoTraits, LayerOrderingTraits, TimeFilterTraits, GetCapabilitiesTraits, RasterLayerTraits, UrlTraits, MappableTraits, CatalogMemberTraits, MinMaxLevelTraits) {
    constructor() {
        super(...arguments);
        this.tileWidth = 256;
        this.tileHeight = 256;
