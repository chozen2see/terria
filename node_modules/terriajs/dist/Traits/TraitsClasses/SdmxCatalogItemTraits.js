...
export default class SdmxCatalogItemTraits extends mixTraits(SdmxCommonTraits, MappableTraits, UrlTraits, DiscretelyTimeVaryingTraits, FeatureInfoTraits, TableTraits, CatalogMemberTraits) {
}
__decorate([
    primitiveTrait({
        type: "string",
