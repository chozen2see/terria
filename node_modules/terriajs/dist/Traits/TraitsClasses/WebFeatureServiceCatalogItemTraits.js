...
export default class WebFeatureServiceCatalogItemTraits extends mixTraits(ExportableTraits, FeatureInfoTraits, LayerOrderingTraits, SplitterTraits, GetCapabilitiesTraits, UrlTraits, MappableTraits, CatalogMemberTraits) {
    constructor() {
        super(...arguments);
