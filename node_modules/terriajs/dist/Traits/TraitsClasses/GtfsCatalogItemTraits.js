...
export default class GtfsCatalogItemTraits extends mixTraits(UrlTraits, CatalogMemberTraits, MappableTraits, RasterLayerTraits, LayerOrderingTraits, AutoRefreshingTraits, FeatureInfoTraits) {
}
__decorate([
    primitiveTrait({
        name: "GTFS API key",
