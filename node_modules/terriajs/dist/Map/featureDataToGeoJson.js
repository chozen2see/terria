...
function getEsriGeometry(featureData, geometryType, spatialReference) {
    if (defined(featureData.features)) {
        ...
        return {
            ...
            features: filterOutUndefined(featureData.features.map(function (subFeatureData) {
    ...
    if (geometryType === "esriGeometryPolygon" && defined(featureData.geometry)) {
        ...
        featureData.geometry.rings.forEach(function (ring) {
            if (computeRingWindingOrder(ring.map(p => new Point(...p))) ===
...
//# sourceMappingURL=featureDataToGeoJson.js.map