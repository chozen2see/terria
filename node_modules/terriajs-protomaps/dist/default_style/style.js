import { PolygonSymbolizer, ShieldSymbolizer, LineSymbolizer, CenteredTextSymbolizer, OffsetTextSymbolizer, GroupSymbolizer, FlexSymbolizer, CircleSymbolizer, PolygonLabelSymbolizer, LineLabelSymbolizer, exp } from '../symbolizer';
import { hsla, parseToHsla } from 'color2k';
const doShading = (params, shade) => {
    let shadeHsl = parseToHsla(shade);
    let outParams = Object.assign({}, params);
...
export const paintRules = (params, shade) => {
    if (shade)
    ...
    return [
        ...
        },
        {
            ...
            filter: (z, f) => { return f.props.natural == "glacier"; }
        },
        {
            dataLayer: "landuse",
            symbolizer: new PolygonSymbolizer({
            ...
            filter: (z, f) => { return f.props.landuse == "residential" || f.props.place == "neighbourhood"; }
        },
        {
            dataLayer: "landuse",
            symbolizer: new PolygonSymbolizer({
            ...
            filter: (z, f) => { return f.props.amenity == "hospital"; }
        },
        {
            dataLayer: "landuse",
            symbolizer: new PolygonSymbolizer({
            ...
            filter: (z, f) => { return f.props.landuse == "cemetery"; }
        },
        {
            dataLayer: "landuse",
            symbolizer: new PolygonSymbolizer({
            ...
            filter: (z, f) => { return f.props.amenity == "school" || f.props.amenity == "kindergarten" || f.props.amenity == "university" || f.props.amenity == "college"; }
        },
        {
            dataLayer: "landuse",
            symbolizer: new PolygonSymbolizer({
            ...
            filter: (z, f) => { return f.props.landuse == "industrial"; }
        },
        {
            dataLayer: "natural",
            symbolizer: new PolygonSymbolizer({
            ...
            filter: (z, f) => { return f.props.natural == "wood"; }
        },
        {
            dataLayer: "landuse",
            symbolizer: new PolygonSymbolizer({
            ...
            filter: (z, f) => { return f.props.landuse == "grass"; }
        },
        {
            dataLayer: "landuse",
            symbolizer: new PolygonSymbolizer({
        ...
        },
        {
            ...
            filter: (z, f) => { return f.props.natural == "sand"; }
        },
        {
            dataLayer: "buildings",
            symbolizer: new PolygonSymbolizer({
...
export const labelRules = (params, shade, language1, language2) => {
    if (shade)
        params = doShading(params, shade);
    var nametags = ["name"];
    if (language1)
